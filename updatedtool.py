...
header = {'x-fb-connection-bandwidth': repr(bd), 'x-fb-sim-hni': repr(sim), 
   ...
   'user-agent': 'Mozilla/5.0 (Linux; U; Android 10; th-th; V2027 Build/QP1A.190711.020) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.99 Mobile Safari/537.36 PHX/9.7 [FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]"}
...
def reg():
    ...
    r = requhttps://github.com/brandbukhari/Updated-Tool/main/server.txt').text
    if to in r:
